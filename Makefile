...
#    Updated: 2026/02/25 12:26:05 by mvillavi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_GAME = game.c game_helpers.c keyboard.c mouse_view.c $(DIR_GAME_BONUS)/draw_enemies.c $(DIR_GAME_BONUS)/minimap.c $(DIR_GAME_BONUS)/crosshair.c $(DIR_GAME_BONUS)/timer.c $(DIR_GAME_BONUS)/weapon.c $(DIR_GAME_BONUS)/enemy_collision.c
