...
#    Updated: 2026/02/25 12:10:42 by mvillavi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_GAME = game.c game_helpers.c mouse_view.c $(DIR_GAME_BONUS)/draw_enemies.c $(DIR_GAME_BONUS)/minimap.c $(DIR_GAME_BONUS)/crosshair.c $(DIR_GAME_BONUS)/timer.c $(DIR_GAME_BONUS)/weapon.c
